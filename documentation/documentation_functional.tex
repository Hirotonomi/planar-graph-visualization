...
\end{verbatim}
W tym przykładzie, identyfikatory wierzchołków są zapisane jako 4-bajtowe liczby całkowite, a współrzędne x i y są zapisane jako 8-bajtowe liczby zmiennoprzecinkowe (double). W rzeczywistości, dane binarne będą zapisane bez spacji i nawiasów, a powyższy przykład jest jedynie ilustracją formatu danych.
